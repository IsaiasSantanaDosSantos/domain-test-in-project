...
import IsaiasPhoto from "../../../public/img/isaias-black_t-shirt.webp";
    ...
    <section id="about">
      <AboutContent>
        ...
        <div className="about-content">
          <div className="about-texts fade-up">
            <p className="main-text">
              {t("main-text")} <span className="my-name"> Isaias Santana</span>
            </p>
          ...
          <div className="about-experience fade-up">
            <p className="experience-number">
              <span className="zoom">20</span>
              <span className="experience-circle"></span>
            </p>
            <p className="experience-text">
              {t("years-of")} <span> {t("experiance")}</span>
            </p>
        ...
        <div className="about-contact fade-up">
          <p>
            {t("name")}: <br />
            <span className="contact-info">Isaias Santana dos Santos</span>
          </p>
          <p>
            {t("email")}: <br />
            <span className="contact-info">
              <a href="malito:santanawebdev@gmail.com">
                santanawebdev@gmail.com
              </a>{" "}
            </span>
          </p>
          <p>
            {t("date birth text")}: <br />
            <span className="contact-info">{t("date birth")}</span>
          </p>
          <p>
            {t("from")}: <br />
            <span className="contact-info">
              <a
                className="loacation"
                href="https://goo.gl/maps/9HeL7UpRSsWs5FU38"
              >
