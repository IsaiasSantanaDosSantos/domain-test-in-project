            ...
            <h1 className=''>{t ('recommendations')}</h1>
                <p className="subTitle fade-up">{t ('recomendations_title')}</p>
                  ...
                  <SlideItem
                    ...
                    photo="img/references/Kim_Frana.jpg"
                    />
                    <SlideItem
                    ...
                    photo="img/references/Abraao_Vasconcelo.jpg"
                    />
                    <SlideItem
                    ...
                    source={t ('recom_source')}
                    photo="img/references/Fabio_Francisco.jpg"
                    />
                    <SlideItem
                    ...
                    source={t ('recom_source')}
                    photo="img/references/Leila_Santana.jpg"
                    />
                  </Slider>
        </ReferencesContent>
    );
